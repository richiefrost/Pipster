...
from TextConverter import TextToSpeech
import json
import subprocess
import os
...
def convert():
    ...
    secure_name = '/app/text/' + secure_name
    new_name = '/app/media/' + book_name + '.mp3'
    ...
    subprocess.Popen(['python3', 'TextConverter.py', '--infile', secure_name, '--outfile', new_name])
